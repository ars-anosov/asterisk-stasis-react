...
var _EndpointRow = require('./EndpointRow');

var _EndpointRow2 = _interopRequireDefault(_EndpointRow);
...
var Endpoints = exports.Endpoints = function (_React$Component) {
  _inherits(Endpoints, _React$Component);
  ...
  function Endpoints(args) {
    ...
    var _this = _possibleConstructorReturn(this, (Endpoints.__proto__ || Object.getPrototypeOf(Endpoints)).call(this, args));
      ...
      _this.props.swgClient.apis.Configuration[_this.apiCmd.get]({ token: _this.apiCmd.token, name: _this.state.inputHostName, group: _this.state.selectHostGroup }).then(function (res) {
        ...
        if (res.status === 200) {
          res.body.map(function (row, i) {
            searchResultTemplate.push(_react2.default.createElement(_EndpointRow2.default, _extends({ Win: _this }, { row: row, key: i })));
          });
        } else {
          console.log(res.body);
        }
  ...
  _createClass(Endpoints, [{
    ...
    value: function render() {
      ...
      var finalTemplate = _react2.default.createElement(
        'div',
        { className: 'endpoints-win' },
        _react2.default.createElement(
          'div',
          { className: 'std-item-header', onClick: this.handleClkShowResult },
          this.props.headerTxt
        ),
        _react2.default.createElement('input', { type: 'text', placeholder: 'hz', value: this.state.inputHostName, onChange: this.handleChangeInput }),
        _react2.default.createElement(
          'select',
